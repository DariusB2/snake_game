...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void newBall() {
        ballX = random.nextInt(SCREEN_WIDTH / UNIT_SIZE) * UNIT_SIZE;
        ballY = random.nextInt(SCREEN_HEIGHT / UNIT_SIZE) * UNIT_SIZE;
    }
    ...
    public void move() {
        ...
        switch (direction) {
            case 'U': //snake moves up
                y[0] = y[0] - UNIT_SIZE;
                break;
            case 'D': //snake moves down
                y[0] = y[0] + UNIT_SIZE;
                break;
            case 'L': //snake moves left
                x[0] = x[0] - UNIT_SIZE;
                break;
            case 'R': //snake moves right
                x[0] = x[0] + UNIT_SIZE;
                break;
        }
    }
